...
public class DateCLI extends Module{
    ...
    public void Run(){
        ...
        try {
            switch (input) {
                case "1" -> dateFormatYYYY = true;
                case "2" -> dateFormatYY = true;
                case "3" -> {dateFormatYYYY = true; dateFormatYY = true;}
                default -> throw new IllegalArgumentException("Invalid argument provided(Y/N)");
            }
